...
User.create!({email: 'qwe1@qwe.qwe', password: 'Qwert123'})
...
Place.create!({name:  FFaker::AddressPL.square, adress: FFaker::AddressPL.street_address, description: FFaker::LoremAR.paragraph, lat: FFaker::Geolocation.lat, long:FFaker::Geolocation.lng, publisher_id: User.all.sample.id, rate: rand(5)})
Place.create!({name:  FFaker::AddressPL.square, adress: FFaker::AddressPL.street_address, description: FFaker::LoremAR.paragraph, lat: FFaker::Geolocation.lat, long:FFaker::Geolocation.lng, publisher_id: User.all.sample.id, rate: rand(5)})
Place.create!({name:  FFaker::AddressPL.square, adress: FFaker::AddressPL.street_address, description: FFaker::LoremAR.paragraph, lat: FFaker::Geolocation.lat, long:FFaker::Geolocation.lng, publisher_id: User.all.sample.id, rate: rand(5)})
Place.create!({name:  FFaker::AddressPL.square, adress: FFaker::AddressPL.street_address, description: FFaker::LoremAR.paragraph, lat: FFaker::Geolocation.lat, long:FFaker::Geolocation.lng, publisher_id: User.all.sample.id, rate: rand(5)})
Place.create!({name:  FFaker::AddressPL.square, adress: FFaker::AddressPL.street_address, description: FFaker::LoremAR.paragraph, lat: FFaker::Geolocation.lat, long:FFaker::Geolocation.lng, publisher_id: User.all.sample.id, rate: rand(5)})
